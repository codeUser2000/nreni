          ...
          <div className="footerBlock">
            ...
            <div className="footerGallery">
              <figure className="footerFigure">
                <img className="footerImg" src="img/post/footer1.jpg" alt="" />
              </figure>
              <figure className="footerFigure">
                <img className="footerImg" src="img/post/footer2.jpg" alt="" />
              </figure>
              <figure className="footerFigure">
                <img className="footerImg" src="img/post/footer1.jpg" alt="" />
              </figure>
              <figure className="footerFigure">
                <img className="footerImg" src="img/post/footer3.jpg" alt="" />
              </figure>
              <figure className="footerFigure">
                <img className="footerImg" src="img/post/footer4.jpg" alt="" />
              </figure>
              <figure className="footerFigure">
                <img className="footerImg" src="img/post/footer3.jpg" alt="" />
              </figure>
          ...
          <div className="footerBlock">
            ...
            <ul className="footerSocBlock">
              ...
              <li className="footerSocList">
                {/* eslint-disable-next-line jsx-a11y/anchor-is-valid */}
                <a target="_blank" href="#" className="footerSocLink">
                  <img src={pinterest} alt="" className="footerSocIcon" />
                </a>
              </li>
            </ul>
          </div>
